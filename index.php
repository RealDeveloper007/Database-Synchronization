<?php 
	$tblist =array('tb_accountdetail','tb_billdetails','tb_caf_return_stock','tb_cafdetail','tb_complaintdetail','tb_connection','tb_connection_stock','tb_departmentdetail','tb_executivedetail','tb_itemdetail','tb_livestockdetail','tb_macdetail','tb_packagedetail','tb_paymentdue','tb_permission','tb_return_executive_items','tb_stockdetail','tb_stockoutdetail','tb_stockoutdetail_copy','tb_taxes','tb_tdstockdetail','tb_tdstockdetail_copy','tb_tempmacdetail','tb_tempstockdetail','tb_tower_stock','tb_towerdetail','tb_users','tb_usertypedetail','tb_vendordetail','temp_userstock','temp_userstock_copy');
?>
<html>
	<head>
	...
	<body>
		<h2>Database Synchronization(Nett1)</h2>
		<div id="tabs">
			<ul>
				<li><a href="#tabs-1">Backup of Nett1</a></li>
		...
		<div align="right">
		<strong>
		<a href="index.php">Database Synchronization(Nett1)</a> | 
		</strong>
		</div>
