<?php 
	$tblist =array('tb_nokia_mars','tb_complaints','tb_hits','tb_logs','tb_provider_accounts','tb_requests','tb_bill_details','tb_user_accounts','tb_temps');
?>
<html>
	<head>
	...
	<body>
		...
		<div id="tabs">
			<ul>
				<li><a href="#tabs-1">Backup of API</a></li>
